...
class HomeController extends Controller
{
    ...
    function storeClient(Request $request){
        ...
        $client->save();
        return redirect('ajouter')->with('message', 'Client inséré avec succès !');
    }
    ...
    public function updateClient(Request $request, $id)
    {
        ...
        $client->save();
        return redirect('/listeClients')->with('message', 'Client Modifié avec succès! ');
    }
    ...
    public function  updateProjetAP(Request $request, $id)
    {
        ...
        if(empty($request->typeA)){
            return redirect('listeProjetAP')->with('message', 'Projet Modifié avec succès! ');
        }
        else{
        $assuranceP = $projetAP->id;
        $type = $request->typeA;
    ...
    function storeAssuranceA(Request $request){
        ...
        return redirect('/assuranceAnimaux')->with('message', 'Un nouveau projet assurance Animal est créé !');
    }
    ...
    public function  updateProjetAA(Request $request, $id)
    {
        ...
        if(empty($request->typeA)){
            return redirect('/listeProjetAA')->with('message', 'Projet Modifié avec succès! ');
        }
        else{
        $assuranceA = $projetAA->id;
        $type = $request->typeA;
    ...
    function storeE(Request $request){
        ...
        $projetE->save();
        return redirect('/emprunteur')->with('message', 'Un nouveau projet emprunteur est créé !');
    }
    ...
    public function  updateProjetE(Request $request, $id)
    {
        ...
        $projetE->save();
        return redirect('/listeProjetE')->with('message', 'Projet Modifié avec succès! ');
    }

        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!--Formulaire-->
                    <form id="msform" action="{{url('/AjouterContratsAA/' .$projetAA->id)}}" method="POST" class="signin-form" enctype="multipart/form-data">
                    @csrf
                        <!-- progressbar -->
                        <ul id="progressbar">
                        ...
                        <fieldset>
                          <h2 class="fs-title">Projet </h2>
                                            ...
                                            <select class="form-control form-control-lg" name="origine">
                                                ...
                                                <input class="form-control form-control-lg" type="datetime" id="PdateC" value="{{$projetAA ->created_at->format('d/m/Y')}}"><br>
                                                <label for="DerniereModification">Dernière modification:</label>
                                                <input class="form-control form-control-lg" type="datetime" id="PdateM" value="{{$projetAA ->updated_at->format('d/m/Y')}}"><br>

...
<div class="sidebar-brand-text mx-3" style="margin-top: 15%;">Carrez Conseil Assurances</div>
            ...
            <!-- Nav Item - contrats Collapse Menu -->
            <li class="nav-item">
            ...
            <div id="content">
               ...
               <div class="container-fluid">
                  ...
                  <div class="container rounded bg-white mt-5 mb-5">
                     <br>
                     <form action="{{url('/assurancePersonne')}}" method="POST" >
                        @csrf
                        <div class="row">
                           <div class="col">
                              <div class="card">
                              ...
                              <div class="card">
                                 ...
                                 <div class="card-body">
                                    ...
                                    {{-- <input type ="number" name="Nombre_Assure" class="form-control form-control-lg"  id="repeater" placeholder="Nombre d'assurés"><br>
      ...
      <script>
         ...
         //          html.innerHTML = '<tr>
         //             <td><select class="form-control form-control-lg"  name="typeA[]"><option value="" selected="selected">- Choisir -</option><option >Célibataire</option><option >Marié(e)</option><option >Concubinage</option><option>Pacsé(e)</option><option >Veuf(ve)</option><option >Divorcé(e)</option><option >Séparé(e)</option></select></td>
         //             <td><select class="form-control form-control-lg" name="civilite[]"><option >Mme</option><option >Mlle</option><option>Mr</option></select></td> 
         //             <td><input class="form-control form-control-lg" style="border-style:none" type="text" name="prenom[]"></td>
         ...
         //             <td><select class="form-control form-control-lg" name="regime[]">
         //                <option  selected="selected">- Choisir -</option>
         //                <option >Salarié</option>
         //                <option>Travailleur non salarié (TNS)</option>
         //                <option >Exploitant agricole</option>

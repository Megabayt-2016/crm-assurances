...
<head>
    ...
    <title> Ajouter Client | Carrez Conseil Assurances</title>
...
<!-- End of Sidebar -->
                    ...
                    <div class="card">
                        ...
                        @if ($errors->any())
                                ...
                                @endif
                                 ...
                                 <form action="{{url('/ajouter')}}" method="POST" class="signin-form">
                                 @csrf
                                    <div class="form-group mb-3">
                                    <label for="civilite"> Civilité :</label>
                                    <select name="civilite" class="form-control form-control-lg">
                                    ...
                                    <div class="form-group mb-3">
                                        <input class="form-control" type="text" name="raisonSociale" placeholder="Raison sociale" />
                                               </div> 
                                    <div class="form-group mb-3">
                                        <input class="form-control" type="text"  name="tele" placeholder="Numéro de téléphone">
                                               </div>
                                    <div class="form-group mb-3">
                                        <input class="form-control" type="text" name="adresse" placeholder="Adresse" />
                                               </div> 
                                    <div class="form-group mb-3">
                                       <input class="form-control" type="text" name="complementAdresse" placeholder="Complément d'adresse" />
                                               </div>
                                    <div class="form-group mb-3">
    ...
    <script>
        var div1 = document.getElementById("Situation1");
        var div2 = document.getElementById("Situation2");
        var div3 = document.getElementById("Situation3");
        
        var sel = document.getElementById("listeSituation");

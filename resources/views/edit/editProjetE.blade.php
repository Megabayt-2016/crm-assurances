...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('/index')}}">
    <div class="sidebar-brand-icon ">
        <i>
            <img src="../../img/CCA-removebg-preview.png" style="margin-top: 15%; width:65%"/> <img src="img/CCA-removebg-preview.png" style="margin-top: 15%; width:65%"/>
        </i>
    </div>
</a>
...
<li class="nav-item">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container rounded bg-white mt-5 mb-5">
                        <br>
                        <form action="{{ url('edit/editProjetE/'.$projetE->id)}}" method="POST" enctype="multipart/form-data" > 
                            ...
                            <div class="col">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <select class="form-control form-control-lg" id="client" name="client_id">
                                             <option value="{{$projetE->client->id}}">{{$projetE->client->nom}} {{$projetE->client->prenom}}</option>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <select class="form-control form-control-lg" id="type" name="type" value="{{ $projetE->type }}" >
                                             <option >{{$projetE->type}}</option>
                                            ...
                                            <select class="form-control form-control-lg" name="origine" value="{{ $projetE->origine }}">
                                                <option >{{$projetE->origine}}</option>
                                            ...
                                            <select class="form-control form-control-lg" name="projetPrioritaire" value="{{ $projetE->projetPrioritaire }}">
                                                <option >{{$projetE->projetPrioritaire}}</option>
                                                <option >Oui</option>
                                                <option >Non</option>
                                            </select><br>
                                            <label for="Statut">Statut :</label>
                                            <select class="form-control form-control-lg" name="statut" value="{{ $projetE->statut }}">
                                                <option >{{$projetE->statut}}</option>
                                                ...
                                                <input class="form-control form-control-lg" type="date" id="PdateS" name="dateSouscription" value="{{ $projetE->dateSouscription }}"><br>
                                                <label for="DateEffet">Date d'effet:</label>
                                                <input class="form-control form-control-lg" type="date" id="PdateEffet" name="dateEffet" value="{{ $projetE->dateEffet }}">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">       
                                                ...
                                                <select class="form-control form-control-lg" name ="user_id" value="{{ $projetE->user_id}} ">
                                                    <option value="{{$projetE->user->id}}"> {{ $projetE-> user -> nom}} {{ $projetE-> user -> prenom}}</option>
                                    ...
                                    <br>                 
                                        ...
                                        <div class="card-body">
                                            <textarea class="form-control form-control-lg" name="commentaire"  rows="6" cols="40">{{ $projetE-> commentaire }}</textarea>
                                        </div> 
                                    </div><br>
                                    <div class="card"> 
    ...
    <script>
        function option(x){
            if(x=="AddAssure"){
                document.getElementById("AddAssure").style.display = "block";
            }
        }
    </script>

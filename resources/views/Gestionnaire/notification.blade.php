...
<head>
    ...
    <title>Notifications | Carrez Conseil Assurances</title>
                    ...
                    <div class="row">
                        <table class="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <th scope="row">{{$event->titreEvent}}</th>
                                <td>{{$event->dateEvent}}</td>
                                <td>
                                    <div>
                                        <center>
                                          <form action="{{url('Gestionnaire/notification/'.$event->id)}}" method="post" style='display: inline-block'>
                                     {{csrf_field() }}
                                     @method('DELETE')
                                          <button type="submit" style='background-color: none; border: none; color: red'> <i class="fa-solid fa-trash-can"></i></button> 
                                         </form>

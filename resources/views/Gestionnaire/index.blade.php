...
<head>
    ...
    <title>Dashboard | Carrez Conseil Assurances</title>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>CARREZ CONSEIL ASSURANCES CRM (Réalisé par EDDDAKKAKI Ibtissame et MEBSAT Nohaila) &copy; 2022 | All Rights Reserved</span>
                </div>
            </div>
        </footer>
            <!-- End of Footer -->

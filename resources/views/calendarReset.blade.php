...
<html lang="en">
   <head>
      ...
      <!--css agenda-->
      <link rel="stylesheet" href="{{('css/rendezvous/rendez-vous.css')}}">
      <script src="{{('js/rendezvous/bootstrap.min.js')}}"></script>
      <script src="{{('js/rendezvous/jquery.min.js')}}"></script>
      <script src="{{('js/rendezvous/main.js')}}"></script>
      <script src="{{('js/rendezvous/popper.js')}}"></script>
   </head>
   <body id="page-top">
      <!-- Page Wrapper -->
      <div id="wrapper">

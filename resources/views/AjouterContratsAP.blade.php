...
<!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!--Formulaire-->
                    <form id="msform" action="{{url('/AjouterContratsAP/'.$projetAP->id)}}" method="POST" class="signin-form" enctype="multipart/form-data"> 
                    @csrf
                        <!-- progressbar -->
                        <ul id="progressbar">
                        ...
                        <fieldset>
                          <h2 class="fs-title">Projet </h2>
                                            ...
                                            <select class="form-control form-control-lg" id="listeType" name="type" >
                                                
                                                <option  value="{{ $projetAP->type }}">{{ $projetAP->type }} </option>
                                            ...
                                            <select class="form-control form-control-lg" name="origine">
                                                ...
                                                <input class="form-control form-control-lg" type="datetime" id="PdateC" value="{{$projetAP ->created_at->format('d/m/Y')}}"><br>
                                                <label for="DerniereModification">Dernière modification:</label>
                                                <input class="form-control form-control-lg" type="datetime" id="PdateM" value="{{$projetAP ->updated_at->format('d/m/Y')}}"><br>
                                                <label for="DateSouscription">Date de souscription:</label>
                                                <input class="form-control form-control-lg" type="date" id="PdateS" value="{{$projetAP->dateSouscription}}"><br>
                                                <label for="DateEffet">Date d'effet:</label>
                                                <input class="form-control form-control-lg" type="date" id="PdateEffet" value="{{$projetAP->dateEffet}}"><br>
                        ...
                        <fieldset>
                          ...
                          <br>
                            ...
                            <input type="number" class="form-control form-control-user" id="S1Frais"
                                    placeholder="Frais d'honoraires" name="Frais_Honoraires" step="any"> <br>
                    ...
                    <!--la partie des documents à ajouter selon la situation -->
                        
                        <!-- type d'assurance auto ou moto-->
                        ...
                        <fieldset>
                            ...
                            <!-- liste déroulante -->
                                ...
                                <select id="listeSituation" class="form-control form-control-lg" name="situation">
                                    <option value="JeuneConducteur">Jeune Conducteur</option>
                                    <option value="RisqueSimple">Risque Simple</option>
                                    <option value="RisqueAggrave">Risque Aggravé</option>
                                </select>
                                ...
                                <!-- Situation 3-->
                                    <div class="custom-file">
                                        <input type="file" name="riptype1" class="custom-file-input" id="chooseFile">
                                        <label class="custom-file-label" for="chooseFile">RIB</label>
                                    </div>
                                    <div class="custom-file">
                                        <input type="file" name="permis" class="custom-file-input" id="chooseFile">
                                        <label class="custom-file-label" for="chooseFile">Permis de conduire ou Carte séjour</label>
                                    </div>
                                    <div class="custom-file">
                                        <input type="file" name="carteG" class="custom-file-input" id="chooseFile">
                                        <label class="custom-file-label" for="chooseFile">Carte Grise ou Certification de cession ou Bon de commande</label>
                                    </div>
                                    <div class="custom-file">
                                        <input type="file" name="releverInfo" class="custom-file-input" id="chooseFile">
                                        <label class="custom-file-label" for="chooseFile">Relevé d'information</label>
                                    </div>
                                    <div class="custom-file">
                                        <input type="file" name="copie" class="custom-file-input" id="chooseFile">
                                        <label class="custom-file-label" for="chooseFile">Copie de jugement</label>
                                    </div>
                                    <div class="custom-file">
                                        <input type="file" name="doc" class="custom-file-input" id="chooseFile">
                                        <label class="custom-file-label" for="chooseFile">Document 3F</label>
                                    </div>
                                    <br> <br>
                                       <center> <h4 style="color:red">Instructions</h4></center>
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">Pour le Jeune Conducteur, les documents à fournir sont : Permis, Carte Grise et le RIB.</li>
                                        <li class="list-group-item">Pour le Risque Simple, les documents à fournir sont en plus de ceux du Jeune Conducteur : Relevé d'information.</li>
                                        <li class="list-group-item">Pour le Risque Aggravé les documents à fournir sont en plus de ceux du Risque Simple: Copie de Jugement et le Document 3F.</li>
                                    </ul>
                            
                            </div> 
                        
                        <!-- type d'assurance santé ou obsèque-->
                        
                            <div id="type2" style= "display:none">

                                    <div class="custom-file">
                                        <input type="file" name="riptype2" class="custom-file-input" id="chooseFile">
                                        <label class="custom-file-label" for="chooseFile">RIB</label>
                                    </div>
                                    <div class="custom-file">
                                        <input type="file" name="carte_vitale" class="custom-file-input" id="chooseFile">
                                        <label class="custom-file-label" for="chooseFile">Carte Vitale</label>
                                    </div>
                                    <div class="custom-file">
                                        <input type="file" name="cintype2" class="custom-file-input" id="chooseFile">
                                        <label class="custom-file-label" for="chooseFile">Pièces d'identité</label>
                                    </div>
                                    <div class="custom-file">
                                        <input type="file" name="attestation_droit" class="custom-file-input" id="chooseFile">
                                        <label class="custom-file-label" for="chooseFile">Attestation de droit </label>
                                    </div>
                                    <div class="custom-file">
                                        <input type="file" name="carte_mutuelle" class="custom-file-input" id="chooseFile">
                                        <label class="custom-file-label" for="chooseFile">Carte Mutuelle</label>
                                    </div>
                            </div>
                        ...
                        <!-- type d'assurance Habitation-->
                            ...
                            <div id="type3" style= "display:none">
                                    <div class="custom-file">
                                        <input type="file" name="riptype3" class="custom-file-input" id="chooseFile" accept="application/pdf">
                                        <label class="custom-file-label" for="chooseFile">RIB</label>
                                    </div>
                                    <div class="custom-file">
                                        <input type="file" name="cintype3" class="custom-file-input" id="chooseFile" accept="application/pdf">
                                        <label class="custom-file-label" for="chooseFile">Pièces d'identité</label>
                                    </div>
                                    <div class="custom-file">
                                        <input type="file" name="cp_cpa" class="custom-file-input" id="chooseFile" accept="application/pdf">
                                        <label class="custom-file-label" for="chooseFile">CP/CPA</label>
                                    </div>
                            </div>
    ...
    <script>
        ...
        var seltype = document.getElementById("listeType");
        var strUser = seltype.options[seltype.selectedIndex].value;
       
        if(strUser=="Assurance Auto" || strUser=="Assurance Moto"){
                type1.style.display = "block";
                type2.style.display = "none";
                type3.style.display = "none";
            }
        else if(strUser=="Complémentaire santé" || strUser=="Assurance Obsèque"){

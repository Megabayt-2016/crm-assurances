...
<head>
    ...
    <title>Contacter vos Clients | Carrez Conseil Assurances</title>
                ...
                <div class="container-fluid"> 
                    <div class="container rounded bg-white mt-5 mb-5">
                        ...
                        <div class="row">
                            ...
                            @endif
                                    <div class="card-body">
                                        <form action="{{url('Admin/contacterClients')}}" method="POST" class="signin-form" enctype="multipart/form-data">
                                        @csrf
                                            <div class="form-group">
                                                <label>Sélectionner le client à contacter</label>
                                                <select class="form-control form-control-lg" name='email'>
                                                    @foreach($client as $client)
                                                    <option value="{{$client->email}}">{{$client->nom}} {{$client->prenom}}</option>
                                            ...
                                            <button  class="form-control btn btn-primary rounded  px-3">Envoyer</button>
                                        </form>
                                    </div>
                                </div>
                            </div>

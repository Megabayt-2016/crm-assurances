...
<head>
    ...
    <title>Importer des clients | Carrez Conseil Assurances</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="wraper">
                    ...
                    <div class="content">
                        <div class="icon"><i >
                            <img src="{{('../img/icons8-ms-excel.svg')}}">
                        </i></div>
                         <div class="text"> Veuillez choisir votre fichier format csv, xlsx ou xlx !</div>
                    </div>
                </div>
                
                <form action="{{url('Admin/importer')}}" method="POST" enctype="multipart/form-data" style="margin-top: 10px">
                    @csrf
                    <div class="form-group">
                        ...
                        <button class="btn btn-primary" type="submit" style="background-color: rgb(2, 129, 2); border-style:none">Importer</button>
                    </div>

...
<head>
    ...
    <title> Assurance Emprunteurs | Carrez Conseil Assurances</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container rounded bg-white mt-5 mb-5">
                        <br>
                        <form action="{{url('Admin/emprunteur')}}" method="POST" > 
                        @csrf
                        <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <select class="form-control form-control-lg" id="type" name="type">
                                                <option >Au cas de Décès</option>
                                                <option >La perte totale et irréversible d'autonomie (PTIA)</option>
                                                <option >L'incapacité temporaire totale (ITT)</option>
                                                <option >L'invalidité permanente totale ou partielle (IPT/ IPP)</option>
                                            </select><br>
                                            <br>

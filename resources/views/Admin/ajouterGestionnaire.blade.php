...
<head>
    ...
    <title> Ajouter un gestionnaire | Carrez Conseil Assurances</title>
                        ...
                        <div class="row">
                            <div class="col">
                             <div class="card">
                                ...
                                @endif
                                 <!--Formulaire-->       
                                 <form action="{{url('/Admin/ajouterGestionnaire')}}" method="POST" class="signin-form">
                                            @csrf
                                              ...
                                              <div class="form-group mb-3">
                                                <input type="text" name="telephone" class="form-control" placeholder="Entrez votre numéro de téléphone" value="">
                                              </div>
                                              <div class="form-group mb-3">
                                                <input type="text" name="adresse" class="form-control" placeholder="Entrez votre adresse" value="">
                                              </div>
                                              <div class="form-group mb-3">
                                                <input type="email" class="form-control" name="email" placeholder="Entrez votre email" value="">
                                              </div>
                                              <div class="form-group mb-3">
                                                <input type="password" name="password" class="form-control" placeholder="Entrez votre mot de passe" value="">
                                              </div>

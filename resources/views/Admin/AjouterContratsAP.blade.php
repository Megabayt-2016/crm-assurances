        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!--Formulaire-->
                    <form id="msform" action="{{url('Admin/AjouterContratsAP/' .$projetAP->id)}}" method="POST" class="signin-form" enctype="multipart/form-data"> 
                    @csrf
                        <!-- progressbar -->
                        <ul id="progressbar">
                        ...
                        <fieldset>
                          <h2 class="fs-title">Projet </h2>
                                            ...
                                            <select class="form-control form-control-lg" id="client" name="client_id">
                                                ...
                                                <option value="{{$projetAP->client->id}}">{{$projetAP->client->nom}} {{$projetAP->client->nom}}</option>
                                            ...
                                            <select class="form-control form-control-lg" name="origine">
                                                ...
                                                <input class="form-control form-control-lg" type="datetime" id="PdateC" value="{{$projetAP -> created_at}}"><br>
                                                <label for="DerniereModification">Dernière modification:</label>
                                                <input class="form-control form-control-lg" type="datetime" id="PdateM" value="{{$projetAP -> updated_at}}"><br>

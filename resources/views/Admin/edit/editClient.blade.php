...
<head>
    ...
    <title> Modifier Client | Carrez Conseil Assurances</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        @if ($errors->any())
                                ...
                                <form action="{{ url('Admin/edit/editClient/'.$client->id)}}"
                                            class="requires-validation" method="POST" enctype="multipart/form-data">
                                            @csrf {{ method_field('PUT') }}
                                    <div class="form-group mb-3">
                                    
                                    <label for="civilite"> Civilité :</label>
                                    <select name="civilite" value="{{ $client->civilite }}" class="form-control form-control-lg">
                                       <option>{{$client->civilite}}</option>
                                       <option name="civilite" >Mme</option>
                                        <option name="civilite" >Mlle</option>
                                        <option name="civilite" >Mr</option>
                                    </select>
                                            </div>
                                    ...
                                    <div class="form-group mb-3">
                                        <input class="form-control " type="text" name="nom" value="{{ $client->nom }}" placeholder="Nom">
                                               </div>

                                    <div class="form-group mb-3">
                                        <input class="form-control" type="text" name="raisonSociale" value="{{ $client->raisonSociale }}" placeholder="Raison sociale" />
                                               </div> 

                                    <div class="form-group mb-3">
                                        <input class="form-control" type="text"  name="tele" value="{{ $client->tele}}" placeholder="Numéro de téléphone">
                                               </div>  

                                    <div class="form-group mb-3">
                                        <input class="form-control" type="text" name="adresse" value="{{ $client->adresse }}" placeholder="Adresse" />
                                               </div> 

                                    <div class="form-group mb-3">
                                       <input class="form-control" type="text" name="complementAdresse" value="{{ $client->complementAdresse }}" placeholder="Complément d'adresse" />
                                               </div> 
                                    
                                    <div class="form-group mb-3">
                                        <input class="form-control" type="email" name="email" value="{{ $client->email }}" placeholder="Adresse e-mail" />
                                               </div>  
                                    
                                    <div class="form-group mb-3">
                                       <input class="form-control" type="number" name="codePostal" value="{{ $client->codePostal }}" placeholder="Code postal" />
                                               </div>  
                                    
                                    <div class="form-group mb-3">
                                        <input class="form-control" type="text" name="ville" value="{{ $client->ville }}" placeholder="Ville" />
                                               </div> 

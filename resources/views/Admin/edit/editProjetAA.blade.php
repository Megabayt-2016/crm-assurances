...
<li class="nav-item">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container rounded bg-white mt-5 mb-5">
                        <br>
                        <form action="{{ url('Admin/edit/editProjetAA/'.$projetAA->id)}}" method="POST" enctype="multipart/form-data" > 
                            ...
                            <div class="col">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <select class="form-control form-control-lg" id="client" name="client_id">
                                             <option value="{{$projetAA->client->id}}">{{$projetAA->client->nom}} {{$projetAA->client->prenom}}</option>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <select class="form-control form-control-lg" id="type" name="type" value="{{ $projetAA->type }}" >
                                            ...
                                            <select class="form-control form-control-lg" name="origine" value="{{ $projetAA->origine }}">
                                            ...
                                            <select class="form-control form-control-lg" name="projetPrioritaire" value="{{ $projetAA->projetPrioritaire }}">
                                                <option >{{$projetAA->projetPrioritaire}}</option>
                                                <option >Oui</option>
                                                <option >Non</option>
                                            </select><br>
                                            <label for="Statut">Statut :</label>
                                            <select class="form-control form-control-lg" name="statut" value="{{ $projetAA->statut }}">
                                                ...
                                                <input class="form-control form-control-lg" type="date" id="PdateS" name="dateSouscription" value="{{ $projetAA->dateSouscription }}"><br>
                                                <label for="DateEffet">Date d'effet:</label>
                                                <input class="form-control form-control-lg" type="date" id="PdateEffet" name="dateEffet" value="{{ $projetAA->dateEffet }}">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">       
                                                ...
                                                <select class="form-control form-control-lg" name ="user_id" value="{{ $projetAA->user_id}} ">
                                                    <option value="{{$projetAA->user->id}}"> {{ $projetAA->user->nom}} {{ $projetAA->user ->prenom}}</option>
                                        ...
                                        <div class="card-body">
                                           ...
                                           <div class="repeater">
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col mb-0">
                                                  <label>Race</label>
                                                  <input class="form-control form-control-lg" type="text" value="{{$assure->race}}" >
                                              </div>
                                                <div class="col mb-0">
                                    ...
                                    <br>                 
                                        ...
                                        <div class="card-body">
                                            <textarea class="form-control form-control-lg" name="commentaire"  rows="6" cols="40">{{ $projetAA-> commentaire }}</textarea>
                                        </div> 
                                    </div><br>
                                    <div class="card"> 
   ...
   let html=`<br><div class="row g-2">
                                          ...
                                          <div class="col mb-0">
                                            <input class="form-control form-control-lg" type="text" name="race[]" placeholder="Race" required>
                                        </div>
                                          <div class="col mb-0">

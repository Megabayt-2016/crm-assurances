...
<head>
    ...
    <title> Modifier un agent | Carrez Conseil Assurances</title>
                             ...
                             <div class="card">
                                ...
                                @endif
                                 <!--Formulaire-->       
                                            ...
                                            <form action="{{ url('Admin/edit/editAgent/'.$agent->id)}}"
                                            ...
                                            <select class="form-control form-control-lg" id="role" name="role">
                                              ...
                                              <div class="form-group mb-3">
                                                    <input type="text" name="nom" value="{{ $agent->nom }}" class="form-control" placeholder="Nom" >
                                                </div>
                                              <div class="form-group mb-3">
                                                <input type="text" name="prenom" value="{{ $agent->prenom }}" class="form-control"  placeholder="Prénom">
                                              </div>
                                              <div class="form-group mb-3">
                                                <input type="text" name="telephone" value="{{ $agent->telephone }}" class="form-control" placeholder="Entrez votre numéro de téléphone" >
                                              </div>
                                              <div class="form-group mb-3">
                                                <input type="text" name="adresse" value="{{ $agent->adresse }}" class="form-control" placeholder="Entrez votre adresse" >
                                              </div>
                                              <div class="form-group mb-3">
                                                <input type="email" name="email" value="{{ $agent->email }}"  class="form-control"  placeholder="Entrez votre email" >
                                              </div>
                                              <div class="form-group mb-3">
                                                <input type="password" name="password" value="{{ $agent->storepassword }}" class="form-control" placeholder="Entrez votre mot de passe" >
                                              </div>

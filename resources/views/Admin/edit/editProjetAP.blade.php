...
<head>
    ...
    <title> Modifier Projet | Carrez Conseil Assurances</title>
...
<li class="nav-item">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container rounded bg-white mt-5 mb-5">
                        <br>
                        <form action="{{ url('Admin/edit/editProjetAP/'.$projetAP->id)}}" method="POST" enctype="multipart/form-data" > 
                            ...
                            <div class="col">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <select class="form-control form-control-lg" id="client" name="client_id">
                                             <option value="{{$projetAP->client->id}}">{{$projetAP->client->nom}} {{$projetAP->client->prenom}}</option>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <select class="form-control form-control-lg" id="type" name="type" value="{{ $projetAP->type }}" >
                                             <option >{{$projetAP->type}}</option>
                                            ...
                                            <select class="form-control form-control-lg" name="origine" value="{{ $projetAP->origine }}">
                                                <option >{{$projetAP->origine}}</option>
                                            ...
                                            <select class="form-control form-control-lg" name="projetPrioritaire" value="{{ $projetAP->projetPrioritaire }}">
                                                <option >{{$projetAP->projetPrioritaire}}</option>
                                                <option >Oui</option>
                                                <option >Non</option>
                                            </select><br>
                                            <label for="Statut">Statut :</label>
                                            <select class="form-control form-control-lg" name="statut" value="{{ $projetAP->statut }}">
                                                <option >{{$projetAP->statut}}</option>
                                                <optgroup label="Opportunité">
                                                    <option value="todo">Projet à traiter</option>
                                                </optgroup>
                                                ...
                                                <optgroup label="Perdu">
                                                    <option value="lost">Perdu (Sans motif)</option>
                                                    <option value="lost_group">Perdu (Mutuelle groupe)</option>
                                                    <option value="lost_acs">Perdu (ACS)</option>
                                                    <option value="lost_price">Perdu (Tarif trop élevé)</option>
                                                    <option value="lost_competitor">Perdu (Souscription à la concurrence)</option>
                                                </optgroup>
                                                <optgroup label="Inexploitable">
                                                    <option value="inexploitable_wrong_phone">Inexploitable (Faux numéro)</option>
                                                    <option value="inexploitable_unassigned_phone">Inexploitable (Numéro non attribué)</option>
                                                    <option value="inexploitable_unreachable">Inexploitable (Injoignable)</option>
                                                    <option value="inexploitable">Inexploitable (Autre cause)</option>
                                                </optgroup>
                                                <optgroup label="Souscription">
                                                    <option value="won">Souscription à traiter</option>
                                                    <option value="subscription_incomplete">Dossier incomplet</option>
                                                    <option value="subscription_complete">Dossier complet</option>
                                                    <option value="subscription_inprogress">En cours</option>
                                                    <option value="subscription_cancel">Annulé</option>
                                                    <option value="subscription_fail">Echec</option>
                                                    <option value="subscription_company_wait">En attente de la compagnie</option>
                                                    <option value="subscription_company_reject">Rejet compagnie</option>
                                                </optgroup>
                                                <optgroup label="Contrat">
                                                    <option value="contract_todo">Contrat à enregistrer</option>
                                                    <option value="contract_active">Contrat enregistré</option>
                                                    <option value="contract_unpaid">Impayé</option>
                                                    <option value="contract_litigation">Contentieux</option>
                                                    <option value="contract_being_terminated">En cours de résiliation</option>
                                                </optgroup>
                                                <optgroup label="Contrat clôturé">
                                                    <option value="contract_retracted">Rétracté</option>
                                                    <option value="contract_terminated">Résilié</option>
                                                    <option value="contract_expired">Echu</option>
                                                </optgroup>
                                                    </select><br>
                                                <label for="DateSouscription">Date de souscription:</label>
                                                <input class="form-control form-control-lg" type="date" id="PdateS" name="dateSouscription" value="{{ $projetAP->dateSouscription }}"><br>
                                                <label for="DateEffet">Date d'effet:</label>
                                                <input class="form-control form-control-lg" type="date" id="PdateEffet" name="dateEffet" value="{{ $projetAP->dateEffet }}">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">       
                                                ...
                                                <select class="form-control form-control-lg" name ="user_id" value="{{ $projetAP->user_id}} ">
                                                    <option value="{{$projetAP->user->id}}"> {{ $projetAP-> user -> nom}} {{ $projetAP-> user -> prenom}}</option>
                                    ...
                                    <div class="card">
                                       ...
                                       <div class="card-body">
                                          ...
                                          {{-- <input type ="number" name="generate" class="form-control form-control-lg"  id="repeater" placeholder="Nombre d'assurés"><br>
                                          <input class="form-control btn btn-primary rounded  px-3" id="btn" value="Gérener">
                                          <br><br>
                                          ...
                                          <div class="repeater">
                                            ...
                                            <div class="row g-2" style="">
                                                ...
                                                <div class="col mb-0">
                                                    ...
                                                    <select class="form-control form-control-lg"  >
                                                        <option>{{$assure->type}}</option>
                                                     </select>
                                                </div>
                                                <div class="col mb-0">
                                                    <label>Civilité</label>
                                                    <select class="form-control form-control-lg" >
                                                        <option>{{$assure->civilite}}</option>
                                                     </select>
                                                </div>
                                                <div class="col mb-0">
                                                    <label>Nom</label>
                                                    <input class="form-control form-control-lg" type="text"  value ="{{$assure->nom}}"  >
                                                </div>
                                                <div class="col mb-0">
                                                    <label>Prénom</label>
                                                    <input class="form-control form-control-lg"  type="text"  value ="{{$assure->prenom}}" >
                                                </div>
                                                <div class="col mb-0">
                                                    <label>Date Naissance</label>
                                                    <input class="form-control form-control-lg" type="date"   value ="{{$assure->dateNaissance}}" >
                                                </div>
                                                <div class="col mb-0">
                                                  <label>Régime</label>
                                                  <select class="form-control form-control-lg" >
                                                    <option>{{$assure->regime}}</option>
                                                  </select>
                                              </div>
                                              
                                                <div class="col mb-0">
                                                    <form action="{{url('Admin/edit/editProjetAP/'.$projetAP->id)}}" method="post" style='display: inline-block'>
                                                        {{csrf_field() }}
                                                        @method('DELETE')
                                                        <button class="btn btn-danger" type="submit" style="margin-top: 30%; height: calc(1.5em + 1rem + 2px);
                                                        padding: 0.5rem 1rem;
                                                        font-size: 1.25rem;
                                                        line-height: 1.5;
                                                        border-radius: 0.3rem;">-</button>
                                            ...
                                            <div class="col mb-0">
                                                <label></label>
                                                <a href="javascript:void(0)" class="btn btn-success addRow form-control" style="margin-top: 6px;
                                    ...
                                    <br> 
                                        ...
                                        <div class="card-body">
                                            <textarea class="form-control form-control-lg" name="commentaire"  rows="6" cols="40">{{ $projetAP-> commentaire }}</textarea>
                                        </div> 
                                    </div><br>
                                    <div class="card"> 
                                    <button  class="form-control btn btn-primary rounded  px-3">Modifier</button>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        //     html1.innerHTML = '<thead "><tr><th>Etat Civile</th><th>Civilité</th><th>Prénom</th><th>Nom</th><th>Date Naissance</th><th>Régime</th></tr></thead>';
        //     tbl.appendChild(html1);

        //     for(let i=0; i<inp; i++){
        //         html = document.createElement("tr");
        //         html.innerHTML = '<tr><td><select class="form-control form-control-lg"  name="typeA[]"><option value="" selected="selected">- Choisir -</option><option >Célibataire</option><option >Marié(e)</option><option >Concubinage</option><option>Pacsé(e)</option><option >Veuf(ve)</option><option >Divorcé(e)</option><option >Séparé(e)</option></select></td><td><select class="form-control form-control-lg" name="civilite[]"><option >Mme</option><option >Mlle</option><option>Mr</option></select></td> <td><input class="form-control form-control-lg" style="border-style:none" type="text" name="prenom[]"></td><td><input class="form-control form-control-lg" type="text" name="nom[]" style="border-style:none" ></td><td><input class="form-control form-control-lg" type="date"  name="dateNaissance[]" style="border-style:none"></td><td><select class="form-control form-control-lg" name="regime[]"><option  selected="selected">- Choisir -</option><option >Salarié</option><option>Travailleur non salarié (TNS)</option><option >Exploitant agricole</option><option >Salarié agricole</option><option >Alsace-Moselle</option><option >Fonction publique</option><option>Retraité salarié</option><option >Retraité TNS</option><option >Retraité Alsace-Moselle</option><option >Etudiant</option></select></td></tr>';
    ...
    let html=`<br><div class="row g-2">
                                         ...
                                         <div class="col mb-0">
                    <a href="javascript:void(0)" class="btn btn-danger deleteRow form-control" style="margin-top: 3px;
                                             height: calc(1.5em + 1rem + 2px);
                                             padding: 0.5rem 1rem;
                                             font-size: 1.2rem;
                                             line-height: 1.5;

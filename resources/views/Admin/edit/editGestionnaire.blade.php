...
<head>
    ...
    <title> Modifier un Gestionnaire | Carrez Conseil Assurances</title>
                             ...
                             <div class="card">
                                ...
                                @endif
                                 ...
                                 <!--Formulaire-->       
                                            ...
                                            <form action="{{ url('Admin/edit/editGestionnaire/'.$gestionnaire->id)}}"
                                            ...
                                            <select class="form-control form-control-lg" id="role" name="role">
                                              ...
                                              <div class="form-group mb-3">
                                                    <input type="text" name="nom" value="{{ $gestionnaire->nom }}" class="form-control" placeholder="Nom" >
                                                </div>
                                              <div class="form-group mb-3">
                                                <input type="text" name="prenom" value="{{ $gestionnaire->prenom }}" class="form-control"  placeholder="Prénom">
                                              </div>
                                              <div class="form-group mb-3">
                                                <input type="text" name="telephone" value="{{ $gestionnaire->telephone }}" class="form-control" placeholder="Entrez votre numéro de téléphone" >
                                              </div>
                                              <div class="form-group mb-3">
                                                <input type="text" name="adresse" value="{{ $gestionnaire->adresse }}" class="form-control" placeholder="Entrez votre adresse" >
                                              </div>
                                              <div class="form-group mb-3">
                                                <input type="email" name="email" value="{{ $gestionnaire->email }}"  class="form-control"  placeholder="Entrez votre email" >
                                              </div>
                                              <div class="form-group mb-3">
                                                <input type="password" name="password" value="{{ $gestionnaire->storepassword }}" class="form-control" placeholder="Entrez votre mot de passe" >
                                              </div>

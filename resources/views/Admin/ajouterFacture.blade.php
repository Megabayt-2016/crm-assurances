...
<head>
    ...
    <title> Ajouter Facture | Carrez Conseil Assurances</title>
    ...
    <script src="{{('../js/ajouter-jquery.min.js')}}" defer></script>
    <script src="{{('../js/ajouter-jquery.easing.min.js')}}" defer></script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <select class="form-control form-control-lg" name="type" id="projet">
                                    <option value="AssuranceP">Assurance Personnes</option>
                                    <option value="AssuranceA">Assurance Animaux</option>
                                    <option value="AssuranceE">Emprunteur</option>
                                </select><br>
                        </div>
                      ...
                      <div class="card">
                        ...
                        <form action="{{url('/Admin/ajouterFacture')}}" method="POST" class="signin-form">
                                            @csrf
                                    ...
                                    <select class="form-control form-control-lg" id="client" name="client_id">
                                        @foreach ($contratAP as $contratAP)
                                            <option value="{{$contratAP->AssurancePersonne->client->id}}" >{{$contratAP->AssurancePersonne->client->nom}} {{$contratAP->AssurancePersonne->client->prenom}}</option>
                                            @endforeach
                                        </select>
                                    <br>
                                   ...
                                   <input class="form-control form-control-lg" type="number" name="Montant" placeholder="Montant" /><br>
                                    ...
                                    <form action="{{url('/Admin/ajouterFacture')}}" method="POST" class="signin-form">
                                                ...
                                                <select class="form-control form-control-lg" id="client" name="client_id">
                                                    @foreach ($contratAA as $contratAA)
                                                        <option value="{{$contratAA->AssurancePersonne->client->id}}" >{{$contratAA->AssurancePersonne->client->nom}} {{$contratAA->AssurancePersonne->client->prenom}}</option>
                                                        @endforeach
                                                    </select>
                                                <br>
                                                <input class="form-control form-control-lg" type="text" name="Designation" placeholder="Designation" /><br>
                                                ...
                                                <form action="{{url('/Admin/ajouterFacture')}}" method="POST" class="signin-form">
                                                            ...
                                                            <select class="form-control form-control-lg" id="client" name="client_id">
                                                                @foreach ($contratE as $contratE)
                                                                    <option value="{{$contratE->AssurancePersonne->client->id}}" >{{$contratE->AssurancePersonne->client->nom}} {{$contratE->AssurancePersonne->client->prenom}}</option>
                                                                    @endforeach
                                                                </select>
                                                            <br>
                                                            <input class="form-control form-control-lg" type="text" name="Designation" placeholder="Designation" /><br>

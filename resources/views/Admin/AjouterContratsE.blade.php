        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!--Formulaire-->
                    <form id="msform" action="{{url('Admin/AjouterContratsE/' .$projetE->id)}}" method="POST" class="signin-form">
                    @csrf
                        <!-- progressbar -->
                        <ul id="progressbar">
                        ...
                        <fieldset>
                          <h2 class="fs-title">Projet </h2>
                                            ...
                                            <select class="form-control form-control-lg" id="client" name="client_id">
                                                ...
                                                <option value="{{$projetE->client->id}}">{{$projetE->client->nom}} {{$projetE->client->nom}}</option>
                                            ...
                                            <select class="form-control form-control-lg" name="origine">
                                                ...
                                                <input class="form-control form-control-lg" type="datetime" id="PdateC" value="{{$projetE ->created_at}}"><br>
                                                <label for="DerniereModification">Dernière modification:</label>
                                                <input class="form-control form-control-lg" type="datetime" id="PdateM" value="{{$projetE ->updated_at}}"><br>
                                                <label for="DateSouscription">Date de souscription:</label>
                                                <input class="form-control form-control-lg" type="date" id="PdateS" value="{{$projetE->dateSouscription}}"><br>
                                                <label for="DateEffet">Date d'effet:</label>
                                                <input class="form-control form-control-lg" type="date" id="PdateEffet" value="{{$projetE->dateEffet}}">

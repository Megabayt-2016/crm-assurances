...
@section('content')
    ...
    <div class="container">
        <div class="card-body bg-white p-2 mt-4">
            <div class="card mb-4">
            <div class="card-body text-center bg-info">Bonjour  <strong>{{ \App\Models\Client::find(decrypt($client_id))->nom}} {{ \App\Models\Client::find(decrypt($client_id))->prenom}} </strong><span class="text-end">(Auto. Risque simple)</span></div>
            </div>
{{--            <b><span style="color: red">Assurez-vous que tous les documents indéxés soient clairs et lisibles.</span></b>--}}
            <form method="post" action="{{ route('uploadingrisquesimple', ['client_id' => request()->segment(count(request()->segments()))]) }}" enctype="multipart/form-data">
                @csrf
                <div class="row mt-3">
                    <div class="col-md-4 mb-4">
                        <label for="carteIdentiteRecto" class="form-label">Carte d'identité (recto) <b style="color: red;">*</b></label>
                        <input class="form-control @error('carteIdentiteRecto') is-invalid @enderror" type="file" name="carteIdentiteRecto" id="carteIdentiteRecto" />
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <input class="form-control @error('carteIdentiteVerso') is-invalid @enderror" type="file" name="carteIdentiteVerso" id="carteIdentiteVerso"/>
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <input class="form-control @error('permisRecto') is-invalid @enderror" type="file" name="permisRecto" id="permisRecto" />
                            @error("permisRecto")
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <input class="form-control @error('permisVerso') is-invalid @enderror" type="file" name="permisVerso" id="permisVerso" />
                            @error("permisVerso")
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <input class="form-control @error('carteGriseRecto') is-invalid @enderror" type="file" name="carteGriseRecto" id="carteGriseRecto" />
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <input class="form-control @error('carteGriseVerso') is-invalid @enderror" type="file" name="carteGriseVerso" id="carteGriseVerso" />
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <input class="form-control @error('releveInformation') is-invalid @enderror" type="file" name="releveInformation" id="releveInformation"/>

...
class CreateContratEmprunteursTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('contrat_emprunteurs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('contrat_emprunteurs');
    }
}
